...
if (isset($_POST['submit'])) {
			...
			$query = "UPDATE project_description set  p_description = '$projo_description', p_attachment = '$projo_attachment' WHERE project_id = '$form_project_id'";
                ...
                <div class="panel-heading">
			  	...
			  	<div class="panel-body">
                    ...
                    <fieldset>
			    		...
			    		<div class="form-group">
			    		    <input class="form-control" placeholder="Project name" name="project_name" type="text" value="<?php echo $projo_name ?>" required>
			    		</div>
			    		<div class="form-group">
			    			Duration:<br>
